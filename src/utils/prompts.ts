...
const FALLBACK_PROMPTS: Record<string, string> = {
  ...
  collection_description_summary:
    "Summarize this YouTube channel description in 1-2 concise, audience-friendly sentences. Avoid links and contact details. Emphasize topics and value to the viewer. Description: {{about_text}}",
  collection_winners_theme:
    "You are Neria. From the last 90 days top-performing video titles, infer a single dominant theme in 3-6 words. Then write ONE short sentence exactly in this format:\n\nA theme that appears to be most popular on your channel is THEME, suggesting we need to lean more this direction.\n\nRules:\n- Replace THEME with the inferred phrase (no braces).\n- Use neutral professional tone.\n- No extra sentences, no emojis.\n- Titles JSON: {{winners_titles}}\n- Channel: {{channel_title}}",
  collection_losers_theme:
    "You are Neria. From the last 90 days worst-performing video titles, infer the single weakest theme in 3-6 words. Then write ONE short sentence exactly in this format:\n\nA theme that appears to be least resonant on your channel is THEME, suggesting we should avoid or radically reframe it.\n\nRules:\n- Replace THEME with the inferred phrase (no braces).\n- Use neutral professional tone.\n- No extra sentences, no emojis.\n- Titles JSON: {{losers_titles}}\n- Channel: {{channel_title}}",
  strategy_generation:
